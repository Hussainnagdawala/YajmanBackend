...
export const exportRegistry: Record<ExportResource, ExportResourceConfig> = {
  orders: {
    ...
    columns: [
      ...
      { header: "Unit Price", key: "unit_price", width: 14, format: "currency" },
  ...
  services: {
    ...
    columns: [
      ...
      { header: "Allow Quantity", key: "allow_quantity", width: 14, format: "boolean" },
      { header: "Max Quantity", key: "max_quantity", width: 12 },
  ...
  coupons: {
    ...
    columns: [
      ...
      { header: "Applicable Services", key: "applicable_services", width: 28 },
      { header: "Created At", key: "created_at", width: 20, format: "datetime" },
    ],
  },
